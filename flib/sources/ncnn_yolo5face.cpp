...
YOLO5Face::YOLO5Face(const std::string& _param_path,
...
void YOLO5Face::transform(const cv::Mat& mat_rs, ncnn::Mat& in)
{
	// BGR NHWC -> RGB NCHW
...
void YOLO5Face::detect(const cv::Mat& mat, std::vector<BoxfWithLandmarks>& detected_boxes_kps,
...
void YOLO5Face::generate_anchors(unsigned int target_height, unsigned int target_width)
{
...
void YOLO5Face::generate_bboxes_kps_single_stride(
...
void YOLO5Face::nms_bboxes_kps(std::vector<BoxfWithLandmarks>& input,
...
void YOLO5Face::print_debug_string()
{
